...
/**
 * Servlet implementation class UpdateGroupInterviewServlet
 */
@WebServlet("/UpdateGroupInterviewServlet")
public class UpdateGroupInterviewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateGroupInterviewServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String alteredComment = request.getParameter("groupcomment");
