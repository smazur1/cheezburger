 ...
 */
@WebServlet("/UpdateCodingTestServlet")
public class UpdateCodingTestServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateCodingTestServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ChApplicationActivity appAct = DBUtil.getApplicationActivityByID(application.getAppid(), 9);
		
		appAct.setActmoddate(now);
		appAct.setActstatus(appActStatus);
		DBUtil.update(appAct);
		
		String alteredComment = request.getParameter("codingtestcomment");
