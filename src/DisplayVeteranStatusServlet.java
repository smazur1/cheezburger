...
/**
 * Servlet implementation class VeteranStatus
 */
@WebServlet("/DisplayVeteranStatusServlet")
public class DisplayVeteranStatusServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayVeteranStatusServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    request.setAttribute("veterancomment", currentComment.getComments());
	    
		request.getRequestDispatcher("VeteranStatus.jsp").forward(request, response);
	}
