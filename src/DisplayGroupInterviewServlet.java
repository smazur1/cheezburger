...
/**
 * Servlet implementation class DisplayGroupInterviewServlet
 */
@WebServlet("/DisplayGroupInterviewServlet")
public class DisplayGroupInterviewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayGroupInterviewServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    request.setAttribute("groupcomment", currentComment.getComments());
	    
		request.getRequestDispatcher("GroupInterview.jsp").forward(request, response);
	}
