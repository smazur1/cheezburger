...
/**
 * Servlet implementation class DisplayHumanResourceInterviewServlet
 */
@WebServlet("/DisplayHumanResourceInterviewServlet")
public class DisplayHumanResourceInterviewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayHumanResourceInterviewServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    request.setAttribute("humanresourcecomment", currentComment.getComments());
