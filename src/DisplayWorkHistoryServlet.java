...
/**
 * Servlet implementation class DisplayWorkHistoryServlet
 */
@WebServlet("/DisplayWorkHistoryServlet")
public class DisplayWorkHistoryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DisplayWorkHistoryServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("workhistorycomment", currentComment.getComments());
