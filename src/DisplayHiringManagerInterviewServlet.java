...
/**
 * Servlet implementation class DisplayHiringManagerInterviewServlet
 */
@WebServlet("/DisplayHiringManagerInterviewServlet")
public class DisplayHiringManagerInterviewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayHiringManagerInterviewServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    request.setAttribute("hiringmanagercomment", currentComment.getComments());
	    
		request.getRequestDispatcher("HiringManagerInterview.jsp").forward(request, response);
	}
