...
/**
 * Servlet implementation class DisplayCodingTestServlet
 */
@WebServlet("/DisplayDrivingRecordReviewServlet")
public class DisplayDrivingRecordReviewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayDrivingRecordReviewServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		long localactid = 11;  //  "Driving Record Review"
	    ...
	    request.setAttribute("drivingrecordcomment", currentComment.getComments());
	    
		request.getRequestDispatcher("DrivingRecordReview.jsp").forward(request, response);
	}
