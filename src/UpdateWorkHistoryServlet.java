...
/**
 * Servlet implementation class UpdateWorkHistoryServlet
 */
@WebServlet("/UpdateWorkHistoryServlet")
public class UpdateWorkHistoryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UpdateWorkHistoryServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ChApplicationActivity appAct = DBUtil.getApplicationActivityByID(application.getAppid(), 2);

		appAct.setActmoddate(now);
		appAct.setActstatus(appActStatus);
		DBUtil.update(appAct);

		String alteredComment = request.getParameter("workhistorycomment");
