 ...
 */
@WebServlet("/DisplayCodingTestServlet")
public class DisplayCodingTestServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayCodingTestServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    request.setAttribute("codingtestcomment", currentComment.getComments());
	    
		request.getRequestDispatcher("CodingTest.jsp").forward(request, response);
	}
