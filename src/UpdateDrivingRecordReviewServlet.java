...
/**
 * Servlet implementation class UpdateCodingTestServlet
 */
@WebServlet("/UpdateDrivingRecordReviewServlet")
public class UpdateDrivingRecordReviewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateDrivingRecordReviewServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ChApplicationActivity appAct = DBUtil.getApplicationActivityByID(application.getAppid(), 11);
		
		appAct.setActmoddate(now);
		appAct.setActstatus(appActStatus);
		DBUtil.update(appAct);
		
		String alteredComment = request.getParameter("drivingrecordcomment");
